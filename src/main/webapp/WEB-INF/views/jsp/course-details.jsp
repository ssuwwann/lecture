    ...
    <div class="row">
      <div class="col-lg-8">
        <div class="course-preview">
          <img src="${pageContext.request.contextPath}/resources/images/course-preview.jpg" alt="">
        ...
        <div class="course-content">
          ...
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eius, quae soluta. Praesentium consequatur odio
        ...
        <div class="course-curriculum">
          ...
          <div class="tab-content">
            <div id="overview" class="tab-pane fade in show active">
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt esse architecto delectus at facere
                maxime totam dolorem eum eligendi ullam laudantium officia temporibus repellat nostrum neque, debitis
                atque sint impedit nemo ipsum! Adipisci dolores ducimus numquam ad cumque possimus? Ex.</p>
            ...
            <div id="courseObj" class="tab-pane fade">
              ...
              <ul>
                ...
                <li><i class="ti-hand-point-right"></i>HTML tags label pieces of content such as "heading", "paragraph",
                  "table", and so on
                </li>
                <li><i class="ti-hand-point-right"></i>Browsers do not display the HTML tags, but use them to render the
                  content of the page
                </li>
              </ul>
            </div>
              ...
              <div class="single-comment">
                <div class="user-thumb">
                  <img class="avatar-small circle"
                       src="${pageContext.request.contextPath}/resources/images/avatar-small.png" alt="">
                </div>
              ...
              <ul class="cmnt-level-2">
                <li>
                  <div class="single-comment">
                    ...
                    <div class="comments-body">
                      <h4>Adam wood</h4>
                      <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maxime ratione libero temporibus quo
            ...
            <li>
              <div class="single-comment">
                ...
                <div class="comments-body">
                  ...
                  <p>Asperiores minus, laborum incidunt explicabo dolore officiis praesentium veniam expedita libero
                    harum pariatur reiciendis porro debitis aliquam quas labore ducimus nisi. Blanditiis?</p>
                  <a href="#"><i class="ti-back-right"></i>Reply</a>
                </div>
              </div>
            </li>
      ...
      <div class="col-lg-4">
        <aside class="sidebar">
          ...
          <div class="widget instractors">
            <figure>
              <img src="${pageContext.request.contextPath}/resources/images/avatar-small.png" alt=""
          ...
          <div class="widget recent-courses">
            ...
            <ul>
              <li>
                <a href="#">
                  <img src="${pageContext.request.contextPath}/resources/images/lectures/3.jpg" alt="">
                  <h5>David Kymen</h5>
              ...
              <li>
                <a href="#">
                  <img src="${pageContext.request.contextPath}/resources/images/lectures/4.jpg" alt="">
                  <h5>Jessi Green</h5>
              ...
              <li>
                <a href="#">
                  <img src="${pageContext.request.contextPath}/resources/images/lectures/1.jpg" alt="">
                  <h5>Adam wood</h5>
