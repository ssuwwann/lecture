...
<section class="about">
  <div class="container">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-md-6">
        <div class="video-box">
          <img src="${pageContext.request.contextPath}/resources/images/video-bg.jpg" alt="">
          <a href="#" class="video-btn"><img src="${pageContext.request.contextPath}/resources/images/youtube.png"
                                             alt=""></a>
        </div>
      </div>
    </div>
...
<section class="certification">
  <div class="container">
    ...
    <div class="partners-caro owl-carousel">
      <a href="#"><img src="${pageContext.request.contextPath}/resources/images/partners/1.png" alt=""></a>
      <a href="#"><img src="${pageContext.request.contextPath}/resources/images/partners/2.png" alt=""></a>
      <a href="#"><img src="${pageContext.request.contextPath}/resources/images/partners/3.png" alt=""></a>
      <a href="#"><img src="${pageContext.request.contextPath}/resources/images/partners/4.png" alt=""></a>
    </div>
  </div>
</section>
